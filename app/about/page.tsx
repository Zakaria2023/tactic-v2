        ...
        {[
          {
            num: "01",
            icon: "V",
            titleKey: "pillar.1.title",
            descKey: "pillar.1.desc",
          },
          {
            num: "02",
            icon: "M",
            titleKey: "pillar.2.title",
            descKey: "pillar.2.desc",
          },
          {
            num: "03",
            icon: "C",
            titleKey: "pillar.3.title",
            descKey: "pillar.3.desc",
          },
        ].map((p) => (
