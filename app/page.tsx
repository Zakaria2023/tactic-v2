...
const services = [
  {
    ...
    descKey: "svc.1.desc",
    features: ["svc.1.f1", "svc.1.f2", "svc.1.f3"],
    tagKey: "svc.tag.popular",
  },
  {
    num: "02",
    mono: "SaaS",
    ...
    descKey: "svc.2.desc",
    features: ["svc.2.f1", "svc.2.f2", "svc.2.f3"],
    tagKey: "svc.tag.new",
  },
  {
    num: "03",
    ...
    descKey: "svc.3.desc",
    features: ["svc.3.f1", "svc.3.f2", "svc.3.f3"],
    tagKey: "svc.tag.enterprise",
  },
  {
    num: "04",
    mono: "App",
    ...
    descKey: "svc.4.desc",
    features: ["svc.4.f1", "svc.4.f2", "svc.4.f3"],
    tagRaw: "iOS / Android",
  },
  {
    num: "05",
    ...
    descKey: "svc.5.desc",
    features: ["svc.5.f1", "svc.5.f2", "svc.5.f3"],
    tagKey: "svc.tag.critical",
  },
  {
    num: "06",
    mono: "Host",
    ...
    descKey: "svc.6.desc",
    features: ["svc.6.f1", "svc.6.f2", "svc.6.f3"],
    tagRaw: "99.9% UPTIME",
  },
  {
    num: "07",
    ...
    descKey: "svc.7.desc",
    features: ["svc.7.f1", "svc.7.f2", "svc.7.f3"],
    tagRaw: "WINDOWS",
  },
  {
    num: "08",
    mono: "UX",
    titleKey: "svc.8.title",
    descKey: "svc.8.desc",
    features: ["svc.8.f1", "svc.8.f2", "svc.8.f3"],
    tagKey: "svc.tag.creative",
  },
  {
    num: "09",
    mono: "24/7",
    titleKey: "svc.9.title",
    descKey: "svc.9.desc",
    features: ["svc.9.f1", "svc.9.f2", "svc.9.f3"],
    tagRaw: "24/7",
  },
];
...
const whyItems = [
  ...
  {
    num: "05",
    titleKey: "why.5.title",
    descKey: "why.5.desc",
    metaKey: "why.5.meta",
  },
  {
    num: "06",
    titleKey: "why.6.title",
    descKey: "why.6.desc",
    metaKey: "why.6.meta",
  },
];
...
const techCats = [
  {
    ...
    tags: ["React", "Vue.js", "Next.js", "Angular", "Three.js", "Tailwind"],
  },
  {
    titleKey: "tech.backend",
    tags: ["Node.js", "Laravel", "Django", ".NET", "Go", "GraphQL"],
  },
  {
...
const offices = [
  {
    country: "jordan" as const,
    code: "HQ — 01",
    nameKey: "office.amman",
    tagKey: "office.amman.tag",
    addrKey: "office.amman.addr",
    email: "amman@takteeq.com",
    phone: "+962 6 500 0000",
    team: "80+",
    clients: "350+",
  },
  {
    country: "syria" as const,
    code: "BR — 02",
    nameKey: "office.aleppo",
    tagKey: "office.aleppo.tag",
    addrKey: "office.aleppo.addr",
    email: "aleppo@takteeq.com",
    phone: "+963 21 200 0000",
    team: "20+",
    clients: "60+",
  },
  {
    ...
    code: "BR — 03",
    nameKey: "office.riyadh",
    tagKey: "office.riyadh.tag",
    addrKey: "office.riyadh.addr",
    email: "riyadh@takteeq.com",
            ...
            <div className="about-visual">
              <div className="hud-frame">
                <div className="hud-line">
                  ...
                  <span className="hud-value">2014</span>
                </div>
                <div className="hud-line">
                  <span>
                    <T k="about.hud.2" />
                  </span>
                  <span className="hud-value">120+</span>
                </div>
                <div className="hud-line">
                  <span>
                    <T k="about.hud.3" />
                  </span>
                  <span className="hud-value active">3</span>
                </div>
                <div className="hud-line">
                  <span>
                    <T k="about.hud.4" />
                  </span>
                  <span className="hud-value active">
                    <T k="about.hud.4.v" />
                  </span>
                </div>
                <div className="hud-line">
                ...
                <p className="hud-label">
                  <T k="about.hud.label2" />
                </p>
                <div className="hud-bar">
                  <div className="hud-bar-fill" style={{ width: "96%" }}></div>
                </div>
                <p className="hud-label">
                  <T k="about.hud.label3" />
                </p>
                <div className="hud-bar">
                  <div className="hud-bar-fill" style={{ width: "99%" }}></div>
                </div>
              </div>
            </div>
          </div>
        ...
        <section id="industries" className="section industries">
          <div className="section-header">
            ...
            <h2 className="section-title">
              ...
              <span className="accent">
                <T k="industries.title.accent" />
              </span>
            </h2>
            <p className="section-subtitle">
              <T k="industries.subtitle" />
            </p>
          </div>
        ...
        <section id="process" className="section process">
          <div className="section-header">
            ...
            <h2 className="section-title">
              ...
              <span className="accent">
                <T k="process.title.accent" />
              </span>
            </h2>
            <p className="section-subtitle">
              <T k="process.subtitle" />
            </p>
          </div>
        ...
        <section id="offices" className="section offices-section">
          <div className="section-header">
            ...
            <h2 className="section-title">
              ...
              <span className="accent">
                <T k="offices.title.accent" />
              </span>
            </h2>
            <p className="section-subtitle">
              <T k="offices.subtitle" />
            </p>
          </div>
                ...
                <div className="office-3d-body">
                  <div className="office-3d-head">
                    <div className="office-3d-meta">
                      ...
                      <span className="office-3d-status">
                        <T k="offices.status" />
                      </span>
                    </div>
                    <h3 className="office-3d-name">
                      <T k={o.nameKey} />
                    </h3>
                    <p className="office-3d-tagline">
                      <T k={o.tagKey} />
                    </p>
                  </div>
                  ...
                  <div className="office-3d-info">
                    <div className="office-3d-row">
                      <span className="office-3d-label">
                        <T k="offices.l.address" />
                      </span>
                      <span className="office-3d-value">
                        <T k={o.addrKey} />
                      </span>
                    </div>
                    <div className="office-3d-row">
                      ...
                      <a href={`mailto:${o.email}`} className="office-3d-link">
                        {o.email}
                      </a>
                    </div>
                    <div className="office-3d-row">
                  ...
                  <div className="office-3d-stats">
                    <div className="office-3d-stat">
                      ...
                      <span className="office-3d-stat-label">
                        <T k="offices.team" />
                      </span>
                    </div>
                    <div className="office-3d-stat">
